...
try {
    ...
    foreach ($productos as $producto) {
        ...
        // Construir las filas de la tabla para el cuerpo HTML
        $tabla_productos_html .= '<tr>
                                    ...
                                    <td width="20%">' . htmlspecialchars($subtotal) . '</td>
                                  </tr>';

        // Construir las filas de la tabla para el cuerpo alternativo de texto
        $tabla_productos_alt .= htmlspecialchars($producto['nombre']) . "          " . htmlspecialchars($producto['cantidad']) . "     " . htmlspecialchars($producto['precio']) . "    " . htmlspecialchars($subtotal) . "\n";
    }
